...
.build-conf:  ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/bulk_usb.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/src/main.o: src/main.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_CC_PRE) -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1 -p$(MP_PROCESSOR_OPTION) -DUSB_INTERRUPT -I"include"  -I ${MP_CC_DIR}/../h  -fo ${OBJECTDIR}/src/main.o   src/main.c 
...
${OBJECTDIR}/src/usb_descriptors.o: src/usb_descriptors.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_CC_PRE) -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1 -p$(MP_PROCESSOR_OPTION) -DUSB_INTERRUPT -I"include"  -I ${MP_CC_DIR}/../h  -fo ${OBJECTDIR}/src/usb_descriptors.o   src/usb_descriptors.c 
...
${OBJECTDIR}/src/usb_device.o: src/usb_device.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_CC_PRE) -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1 -p$(MP_PROCESSOR_OPTION) -DUSB_INTERRUPT -I"include"  -I ${MP_CC_DIR}/../h  -fo ${OBJECTDIR}/src/usb_device.o   src/usb_device.c 
...
${OBJECTDIR}/src/callback.o: src/callback.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_CC_PRE) -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1 -p$(MP_PROCESSOR_OPTION) -DUSB_INTERRUPT -I"include"  -I ${MP_CC_DIR}/../h  -fo ${OBJECTDIR}/src/callback.o   src/callback.c 
...
${OBJECTDIR}/src/main.o: src/main.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR}/src 
	@${RM} ${OBJECTDIR}/src/main.o.d 
	${MP_CC} $(MP_EXTRA_CC_PRE) -p$(MP_PROCESSOR_OPTION) -DUSB_INTERRUPT -I"include"  -I ${MP_CC_DIR}/../h  -fo ${OBJECTDIR}/src/main.o   src/main.c 
	@${DEP_GEN} -d ${OBJECTDIR}/src/main.o 
	
${OBJECTDIR}/src/usb_descriptors.o: src/usb_descriptors.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR}/src 
	@${RM} ${OBJECTDIR}/src/usb_descriptors.o.d 
	${MP_CC} $(MP_EXTRA_CC_PRE) -p$(MP_PROCESSOR_OPTION) -DUSB_INTERRUPT -I"include"  -I ${MP_CC_DIR}/../h  -fo ${OBJECTDIR}/src/usb_descriptors.o   src/usb_descriptors.c 
	@${DEP_GEN} -d ${OBJECTDIR}/src/usb_descriptors.o 
	
${OBJECTDIR}/src/usb_device.o: src/usb_device.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR}/src 
	@${RM} ${OBJECTDIR}/src/usb_device.o.d 
	${MP_CC} $(MP_EXTRA_CC_PRE) -p$(MP_PROCESSOR_OPTION) -DUSB_INTERRUPT -I"include"  -I ${MP_CC_DIR}/../h  -fo ${OBJECTDIR}/src/usb_device.o   src/usb_device.c 
	@${DEP_GEN} -d ${OBJECTDIR}/src/usb_device.o 
	
${OBJECTDIR}/src/callback.o: src/callback.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR}/src 
	@${RM} ${OBJECTDIR}/src/callback.o.d 
	${MP_CC} $(MP_EXTRA_CC_PRE) -p$(MP_PROCESSOR_OPTION) -DUSB_INTERRUPT -I"include"  -I ${MP_CC_DIR}/../h  -fo ${OBJECTDIR}/src/callback.o   src/callback.c 
	@${DEP_GEN} -d ${OBJECTDIR}/src/callback.o 
